...
class MetaMaskProvider extends ChangeNotifier {
  ...
  final abi = [
    ...
    "function addLand(uint _area, string memory _address, uint landPrice,string memory _allLatiLongi, uint _landPID,string memory _surveyNum, string memory _document) public",
    "function myAllLands(address id) public view returns( uint[] memory)",
    "function lands(uint) public view returns(uint id,uint area,string landAddress,uint landPrice,string allLatitudeLongitude,uint landPID,string physicalSurveyNumber,string document,bool isforSell,address payable ownerAddress,bool isLandVerified)",
