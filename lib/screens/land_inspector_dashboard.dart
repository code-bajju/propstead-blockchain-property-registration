...
class _LandInspectorState extends State<LandInspector> {
  ...
  List<Menu> menuItems = [
    ...
    Menu(title: 'Verify User', icon: Icons.verified_user, subItems: []),
    Menu(title: 'Verify Land', icon: Icons.web, subItems: []),
    Menu(title: 'Transfer Ownership', icon: Icons.transform, subItems: []),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (index == 1)
                  const Text('Total Land Registered',
                      style: TextStyle(fontSize: 20)),
                if (index == 2)
                  const Text('Total Land Transfered ',
                      style: TextStyle(fontSize: 20)),
              ],
            ),
          ),
