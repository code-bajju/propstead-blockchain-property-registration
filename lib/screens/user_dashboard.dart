...
class _UserDashBoardState extends State<UserDashBoard> {
  ...
  List<Menu> menuItems = [
    ...
    Menu(title: 'Dashboard', icon: Icons.dashboard, subItems: []),
    Menu(title: 'Add Lands', icon: Icons.add_chart, subItems: []),
    Menu(title: 'My Lands', icon: Icons.landscape_rounded, subItems: []),
    Menu(title: 'Land Gallery', icon: Icons.landscape_rounded, subItems: []),
    Menu(title: 'My Received Request', icon: Icons.request_page_outlined, subItems: []),
    Menu(title: 'My Sent Land Request', icon: Icons.request_page_outlined, subItems: [], ),
    Menu(title: 'My Bids', icon: Icons.attach_money, subItems: []),

    Menu(title: 'Logout', icon: Icons.logout, subItems: []),
  ];
