...
class _AddLandInspectorState extends State<AddLandInspector> {
  ...
  List<Menu> menuItems = [
    Menu(title: 'Add Land Inspector', icon: Icons.person_add, subItems: []),
    Menu(title: 'All Land Inspectors', icon: Icons.group, subItems: []),
    Menu(title: 'Change Contract Owner', icon: Icons.change_circle, subItems: []),
